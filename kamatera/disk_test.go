...
func Test_calDiskChangeOperation(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			expected: diskOperation{update: map[int]int{1: 457}},
		},
		{
			name:     "update only integers",
			o:        []interface{}{123, 456},
			n:        []interface{}{123, 457},
			expected: diskOperation{update: map[int]int{1: 457}},
		},
		...
		},
		{
			...
			expected: diskOperation{add: []int{456}},
		},
		{
			name:     "update and add",
			o:        []interface{}{123.0},
			n:        []interface{}{124.0, 456.0},
			expected: diskOperation{add: []int{456}, update: map[int]int{0: 124}},
		},
		{
			name:     "update and remove",
			o:        []interface{}{123.0, 456.0},
			n:        []interface{}{124.0},
			expected: diskOperation{remove: []int{1}, update: map[int]int{0: 124}},
		},
		{
		...
		},
		{
			...
			n:        []interface{}{123.0, 456.0},
			expected: diskOperation{update: map[int]int{1: 456.0}},
		},
		{
			name: "update 4 disks",
			o:    []interface{}{1.0, 2.0, 3.0, 4.0},
			n:    []interface{}{2.0, 3.0, 4.0, 5.0},
			expected: diskOperation{update: map[int]int{
				0: 2,
				1: 3,
				2: 4,
				3: 5,
